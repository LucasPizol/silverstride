...
export default function Contact() {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      title: "Email",
      content: "info@silverstridept.com",
    ...
    },
    {
      ...
      subContent: "Medical District, State 12345",
    },
    {
      icon: (
        <svg
      ...
      <div className="container-custom">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-gray-600">
            Estamos aqui para ajudar você a dar o primeiro passo em direção a
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                >
                  ...
                  <option value="geriatric">Fisioterapia Geriátrica</option>
